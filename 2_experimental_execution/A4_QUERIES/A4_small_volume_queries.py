# Experimentation A4 small volume
...
# Start ontopVKG with a connection to large volume postgres database with internal data (grpaphDB need to be launched and contains external data graph)
commande_str = "ontop endpoint -m ../general/store_mapping_v3_intrerne.ttl -t ../general/products_and_sales_ontology.xml -p ../general/local_postgres_small_volume.properties"
...
SELECT ?siret ?iriszone ?persongroup ?activity_name ?nb_person WHERE {
