# Experimentation A5 large volume

# Imports
import sparql_dataframe

# Note: Start GraphDB external data graph and large internal data graph
endpoint = "http://localhost:7200/repositories/rdf_gros_volumes"
