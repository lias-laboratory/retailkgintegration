# Experimentation A1 small volume
...
# Start ontopVKG with a connection to small volume postgres database
commande_str = "ontop endpoint -m ../general/store_mapping_v3_intrerne.ttl -t ../general/products_and_sales_ontology.xml -p ../general/local_postgres_petit_volume.properties"
