# Experimentation A6 small volume

# Imports
import sparql_dataframe

# Note: Start GraphDB small internal external data graph
endpoint = "http://localhost:7200/repositories/rdf_petit_volumes_interne_externe"
