# Experimentation A2 small volume

import subprocess
import os
import sparql_dataframe

# Start ontopVKG with a connection to small volume postgres database with internal and external data

commande_str = "ontop endpoint -m ../general/store_mapping_v3_intrerne_externe.ttl -t ../general/products_and_sales_ontology.xml -p ../general/local_postgres_petit_volume_interne_externe.properties"
